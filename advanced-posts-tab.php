 ...
 * Description: Advanced post tab is an Elementor plugin that contains 29+ ready-made styunning style.
 * Plugin URI:  https://bwdplugins.com/post-tab
 * Version:     1.0
...
require_once ( plugin_dir_path(__FILE__) ) . '/includes/apostst-plugin-activition.php';
final class FinalFPOSTGFilterable{
	...
	public function apostst_loaded_textdomain() {
		load_plugin_textdomain( 'advanced-posts-tab' );
	}
	...
	public function apostst_init() {
		...
		if ( ! version_compare( ELEMENTOR_VERSION, self::MINIMUM_ELEMENTOR_VERSION, '>=' ) ) {
			add_action( 'admin_notices', 'apostst_admin_notice_minimum_elementor_version' );
			return;
		}
