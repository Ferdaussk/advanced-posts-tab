...
class FPOSTGfilterable extends Widget_Base {
	...
	public function get_icon() {
		return 'apostst-filterable-icon fas fa-th';
	}

	public function get_categories() {
		return [ 'bwdthebest_blogs_category' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'apostst_blog_content_pagination_section',
			[
		...
		$this->add_responsive_control(
			'apostst_the_pagination_items_align',
			[
				...
				'condition' => [
					'apostst_the_pagination_type' => ['number-and-text', 'number'],
				],
				'toggle' => true,
			]
		);
		$this->add_control(
			'apostst_blog_next_format',
			[
				...
				'label_block' => true,
				'condition' => [
					'apostst_the_pagination_type' => 'number-and-text',
				],
			]
		);
		$this->add_control(
			'apostst_blog_prev_format',
			[
		...
		$this->start_controls_section(
			'apostst_blog_pagination_style_section',
			[
		...
		$this->add_responsive_control(
			'apostst_blog_button_box_pagi_margin_top',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		// Hover control start for pagination
		$this->start_controls_tabs(
			'apostst_blog_pagination_style_post'
		);
		$this->start_controls_tab(
			'apostst_blog_pagination_normal_post',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'apostst_blog_pagination_typography',
				'selector' => '{{WRAPPER}} .apostst_pagination_item a',
			]
		);
		$this->add_control(
			'apostst_blog_pagination_color',
			[
				'label' => esc_html__( 'Color', 'blog-post-list' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item a' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			'apostst_blog_pagination_bg_color',
			[
				'label' => esc_html__( 'Background', 'blog-post-list' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item a' => 'background: {{VALUE}}',
				],
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			'apostst_blog_pagination_hover_tab',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'apostst_blog_pagination_hover_typography',
				'selector' => '{{WRAPPER}} .apostst_pagination_item span, {{WRAPPER}} .apostst_pagination_item a:hover',
			]
		);
		$this->add_control(
			'apostst_blog_pagination_hover_color',
			[
				'label' => esc_html__( 'Active Color', 'blog-post-list' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item span, {{WRAPPER}} .apostst_pagination_item a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			'apostst_blog_pagination_hover_bg_color',
			[
				'label' => esc_html__( 'Background', 'blog-post-list' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item span, {{WRAPPER}} .apostst_pagination_item a:hover' => 'background: {{VALUE}}',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item a, {{WRAPPER}} .apostst_pagination_item span' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'apostst_blog_button_box_height',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .apostst_pagination_item a, {{WRAPPER}} .apostst_pagination_item span' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
            'apostst_blog_the_pagination_page',
            [
                'label' => esc_html__('Border Radius', 'blog-post-list'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .apostst_pagination_item a, {{WRAPPER}} .apostst_pagination_item span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            'apostst_blog_the_pagination_margin',
            [
                'label' => esc_html__('Margin', 'blog-post-list'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .apostst_pagination_item a, {{WRAPPER}} .apostst_pagination_item span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_section();
	...
	protected function render() {
		...
		$apostst_post_per_page = $apostst_display['apostst_the_post_per_page'];
		...
		$apostst_the_pagination_type = $apostst_display['apostst_the_pagination_type'];
		$apostst_the_pagination_items_align = $apostst_display['apostst_the_pagination_items_align'];
		if('filter_left' === $apostst_the_pagination_items_align){
			$apostst_pagination_position = 'text-start';
		} elseif('filter_center' === $apostst_the_pagination_items_align){
			$apostst_pagination_position = 'text-center';
		} elseif('right' === $apostst_the_pagination_items_align){
			$apostst_pagination_position = 'text-end';
		} else{ $apostst_pagination_position = ''; }

		$all_tst_args = array('post_type' => 'post', 'posts_per_page' => $apostst_post_per_page, 'author__in' => $apostst_author, 'orderby' => $apostst_order_by, 'order' => $apostst_blog_order, 'post__not_in' => [$apostst_blog_pst_exclude]);
